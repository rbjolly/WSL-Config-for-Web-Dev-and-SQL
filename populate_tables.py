...
#   psycopg2==2.8.5
#   python-decouple==3.3
# But to run under Ubuntu 20.04 on WSL, which has a version of Python which is not compatible with the above listed modules, you'll need to install an alternative. I chose pg8000.
